...
export const Notes = (props) => {
  ...
  //This is used to store the content on the modal and not on the card/through database
  ...
  //This updateNote function will be called when we click the edit button on the card and populate the fields of the modal with the existing one present in card
